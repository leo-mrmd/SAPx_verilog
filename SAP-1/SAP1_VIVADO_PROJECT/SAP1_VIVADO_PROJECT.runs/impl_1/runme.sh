...
HD_PWD='/home/leo_mrmd/Documents/SAPx_verilog/SAP-1/SAP1_VIVADO_PROJECT/SAP1_VIVADO_PROJECT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sap1_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sap1_top.tcl -notrace
